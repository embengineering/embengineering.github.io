  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4 sm:p-8 overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 z-0 bg-gray-50 dark:bg-gray-950 transition-colors duration-700">
        <div
          className="absolute inset-0 bg-cover bg-center opacity-30 dark:opacity-10 mix-blend-overlay"
          style={{ backgroundImage: 'var(--background-image-screen-image)' }}
        ></div>
      ...
      >
        {!isDark ? (
          <svg
            className="w-6 h-6 text-gray-800 group-hover:text-yellow-500 transition-colors"
            fill="currentColor"
            viewBox="0 0 20 20"
          >
          ...
          <svg
            className="w-6 h-6 text-gray-200 group-hover:text-blue-400 transition-colors"
            fill="currentColor"
            viewBox="0 0 20 20"
          >
      ...
      <div className="z-10 w-full max-w-4xl glass rounded-[2rem] overflow-hidden flex flex-col md:flex-row animate-fade-in-up opacity-0">
        ...
        <div className="md:w-2/5 relative h-64 md:h-auto shrink-0">
          <div
            ...
            style={{
              backgroundImage: 'var(--background-image-profile-desktop)',
            }}
          ></div>
