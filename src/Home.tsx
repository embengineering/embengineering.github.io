  ...
  return (
    <div className="max-w-7xl max-h-screen h-screen flex items-center justify-center px-6 mx-auto">
      ...
      <div className="fixed top-2 right-2">
        <button
          className="rounded-full bg-green-700 hover:bg-green-900 hover:bg-grey text-grey-darkest font-bold p-2 inline-flex items-center opacity-75 dark:opacity-75 shadow"
