...
const personalInfo = {
  fullName: 'Emmanuel Morales Betancourt',
};
...
const ImageCol = () => {
  return (
    <div className="w-full lg:w-2/5">
      <div className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block w-[400px] h-[600px] bg-cover bg-center bg-profile-desktop"></div>
    </div>
  );
};
